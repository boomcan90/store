...
# Orders
# o1 = Order(customer_id='cid1')
# o2 = Order(customer_id='cid2')
# o3 = Order(customer_id='cid3')
# o4 = Order(customer_id='cid4')
# o5 = Order(customer_id='cid5')
# o6 = Order(customer_id='cid6')A
# o7 = Order(customer_id='cid7')
# o8 = Order(customer_id='cid8')
# o9 = Order(customer_id='cid9')
# o10 = Order(customer_id='cid10')
# o11 = Order(customer_id='cid1')
# o12 = Order(customer_id='cid1')
# o13 = Order(customer_id='cid2')
# o15 = Order(customer_id='cid7')
# o16 = Order(customer_id='cid7')
# o17 = Order(customer_id='cid7')
# o18 = Order(customer_id='cid3')
