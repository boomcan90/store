...
# Orders
o1 = Order.create(customer_id='cid1')
o2 = Order.create(customer_id='cid2')
o3 = Order.create(customer_id='cid3')
o4 = Order.create(customer_id='cid4')
o5 = Order.create(customer_id='cid5')
o6 = Order.create(customer_id='cid6')
o7 = Order.create(customer_id='cid7')
o8 = Order.create(customer_id='cid8')
o9 = Order.create(customer_id='cid9')
o10 = Order.create(customer_id='cid10')
o11 = Order.create(customer_id='cid1')
o12 = Order.create(customer_id='cid1')
o13 = Order.create(customer_id='cid2')
o15 = Order.create(customer_id='cid7')
o16 = Order.create(customer_id='cid7')
o17 = Order.create(customer_id='cid7')
o18 = Order.create(customer_id='cid3')
